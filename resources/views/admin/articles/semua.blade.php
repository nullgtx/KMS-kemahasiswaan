                  ...
                  @foreach($berita as $article)
                    ...
                    <div class="post">
                      <div class="user-block">
                        ...
                        <h4> <a href="{{route('admin.articles.view', $article->id)}}">{{$article->title}} </a> </h4>
                        </span>
                        <span class="description">{{$article->created_at}}</span>
                      </div>
                      <!-- /.user-block -->
                      <p>
                      {!! str_limit ($article->content, 200, ' ...')!!} <a href="{{route('admin.articles.view', $article->id)}}">Lihat detail </a>                   
                      </p>
